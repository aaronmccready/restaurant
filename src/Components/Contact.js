        ...
        <div id="contactFormDiv">
            ...
            <form id="contactForm" onSubmit={(e) => submitContactForm(e)}>
                ...
                <label htmlFor="subject">
                    Subject:
                    <input id="subject" type="text" value={subject} onChange={(e) => setSubject(e.target.value)} required></input>
                </label>
                <label htmlFor="message">
                    Message:
                    <textarea id="message" type="text" value={message} onChange={(e) => setMessage(e.target.value)} required></textarea>
                </label>
                <button type="submit">
                    <b>Send</b>
                </button>
